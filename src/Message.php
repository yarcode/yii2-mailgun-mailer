...
class Message extends BaseMessage
{
    ...
    {
        return implode(', ', $this->getMessagePart('bcc'));
    }
    ...
    {
        return implode(', ', $this->getMessagePart('cc'));
    }
    ...
    {
        return implode(', ', $this->getMessagePart('from'));
    }
    ...
    {
        return implode(', ', $this->getMessagePart('to'));
    }
